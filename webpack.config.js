...
module.exports = env => {
  ...
  const plugins = [
    ...
    new webpack.DefinePlugin({
      'process.env.CT_APIID': JSON.stringify(process.env.CT_APIID),
      'process.env.CT_REGION': JSON.stringify(process.env.CT_REGION),
      'process.env.CT_STAGE': JSON.stringify(process.env.CT_STAGE),
    }),
