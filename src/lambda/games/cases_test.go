...
var modifyLiveGamePayload_MarshalJSON_Tests = []struct {
	...
	{
		input:       modifyLiveGamePayload{ModLiveGame: liveGame{Sk: "123456789", CurrentWord: "bark", PreviousWord: "moon", Players: livePlayerList{{Name: "p1", ConnID: "111", Color: "red", Score: 10, Answer: answer{PlayerID: "p1", Answer: "heart"}, HasAnswered: false}, {Name: "p2", ConnID: "222", Color: "green", Score: 20, Answer: answer{PlayerID: "p2", Answer: ""}, HasAnswered: false}, {Name: "p3", ConnID: "333", Color: "yellow", Score: 7, Answer: answer{PlayerID: "p3", Answer: ""}, HasAnswered: false}}, AnswersCount: 1}},
		expected:    liveGameWrap{MdLveGm: liveGame{Sk: "123456789", CurrentWord: "bark", PreviousWord: "moon", Players: livePlayerList{{Name: "p1", ConnID: "111", Color: "red", Score: 10, Answer: answer{PlayerID: "p1", Answer: ""}, HasAnswered: true}, {Name: "p2", ConnID: "222", Color: "green", Score: 20, Answer: answer{PlayerID: "p2", Answer: ""}, HasAnswered: false}, {Name: "p3", ConnID: "333", Color: "yellow", Score: 7, Answer: answer{PlayerID: "p3", Answer: ""}, HasAnswered: false}}}},
...
// }{
// 	{
// 		input:       modifyLiveGamePayload{ModLiveGame: liveGame{No: "123456789", CurrentWord: "bark", PreviousWord: "moon", Players: livePlayerList{{Name: "p1", ConnID: "111", Color: "red", Score: 10, Answer: answer{PlayerID: "p1", Answer: "heart"}, HasAnswered: false}, {Name: "p2", ConnID: "222", Color: "green", Score: 20, Answer: answer{PlayerID: "p2", Answer: "verb"}, HasAnswered: false}, {Name: "p3", ConnID: "333", Color: "yellow", Score: 7, Answer: answer{PlayerID: "p3", Answer: "meal"}, HasAnswered: false}}, AnswersCount: 3}},
