...
var modifyLiveGamePayload_MarshalJSON_Tests = []struct {
	...
	{
		input:       modifyLiveGamePayload{ModLiveGame: liveGame{Sk: "12389", CurrentWord: "bark", PreviousWord: "moon", Players: livePlayerList{{Name: "p1", ConnID: "111", Color: "red", Score: 10, Answer: "heart", HasAnswered: false}, {Name: "p2", ConnID: "222", Color: "green", Score: 20, Answer: "", HasAnswered: false}, {Name: "p3", ConnID: "333", Color: "yellow", Score: 7, Answer: "", HasAnswered: false}}, AnswersCount: 1}},
	...
	{
		input:       modifyLiveGamePayload{ModLiveGame: liveGame{Sk: "16789", CurrentWord: "bark", PreviousWord: "moon", Players: livePlayerList{{Name: "p1", ConnID: "111", Color: "red", Score: 10, Answer: "heart", HasAnswered: false}, {Name: "p2", ConnID: "222", Color: "green", Score: 20, Answer: "", HasAnswered: false}, {Name: "p3", ConnID: "333", Color: "yellow", Score: 7, Answer: "meal", HasAnswered: false}}, AnswersCount: 2}},
